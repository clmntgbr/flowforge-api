...
func NewInsightResponse(insight *entity.Insight) InsightResponse {
	...
	return InsightResponse{
		...
		QueueTime:         insight.QueueTime.ToDuration(),
		DNSLookupDuration: insight.DNSLookupDuration.ToDuration(),
		TCPConnectionTime: insight.TCPConnectionTime.ToDuration(),
		TLSHandshakeTime:  insight.TLSHandshakeTime.ToDuration(),
		TTFB:              insight.TTFB.ToDuration(),
		Duration:          insight.Duration.ToDuration(),
